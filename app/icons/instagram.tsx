...
export const InstagramIcon: () => React.SVGProps<React.ReactElement> = (): SVGProps<ReactElement>=> {
    return (<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 50 50">
