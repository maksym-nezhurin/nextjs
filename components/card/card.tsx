...
export const Card = (props: ICardProps):ReactElement => {
    const { id, image: { src, title: altTitle }, title, description, subtitle, author} = props;

    return (<div key={id} className="max-w-sm w-full lg:max-w-full lg:flex cardItem">
            { <div
                className="h-48 lg:h-auto lg:w-48 flex-none bg-cover rounded-t lg:rounded-l text-center overflow-hidden"
            ...
            <div
                ...
                <div className="mb-8">
                    { subtitle && (<p className="text-sm text-gray-600 flex items-center">
                    ...
                    <div className="text-gray-900 font-bold text-sm mb-2">{title}</div>
